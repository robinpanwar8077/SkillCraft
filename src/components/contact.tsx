        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-4">
              {/* Compact Venue Card */}
              <div className="bg-zinc-50 border border-zinc-200 rounded-[2rem] p-5 sm:p-6 transition-all hover:border-blue-300 shadow-sm relative overflow-hidden group">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-grow">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[10px] font-black uppercase tracking-wider">
                      ...
                      <div className="flex items-center gap-2 text-zinc-600 bg-white px-3 py-1.5 rounded-xl border border-zinc-200">
